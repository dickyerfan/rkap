 ...
 <section id="hero" class="hero">
         ...
         <div class="container">
             <div class="row justify-content-center">
                 <div class="col-lg-8 text-center">
                     <h2 data-aos="fade-down">Selamat Datang <br> <span>Di Website PDAM Bondowoso</span>
                     </h2>
                     <p data-aos="fade-up">PDAM Bondowoso merupakan Badan Usaha Milik Daerah yang bergerak di bidang penyediaan
                         air
                         bersih untuk wilayah
                         Kabupaten Bondowoso <br> dan penyediaan air minum dalam kemasan bernama Ijen Water</p>
                     <a data-aos="fade-up" data-aos-delay="200" href="#sejarah" class="btn-sejarah">Lihat
                         Selengkapnya</a>
                 </div>
             </div>
         </div>
     ...
     <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
         ...
         <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/hero5.jpg)"></div>
         <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/hero6.jpg)"></div>
         ...
         <div class="container">
             ...
             <div class="row justify-content-between gy-4">
                 ...
                 <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up">
                     <div class="content">
                         <h3>Sejarah Singkat PDAM Bondowoso</h3>
                         <p>Perusahaan Daerah Air Minum (PDAM) Kabupaten Bondowoso adalah Badan Usaha Milik Pemerintah Kabupaten
                             Bondowoso yang telah lama berdiri mulai tahun
                             1989 dan sejak tahun 1993 sah terlegitimasi secara hukum menjadi Badan
                             Usaha Milik Daerah (BUMD). Artinya segala aktivitas yang berkaitan dengan
                             manajerial sumber daya manusia internnya, pengelolaan sumber daya air, dan
                             sasaran masyarakat berada dalam pengawasan serta perlindungan Pemerintah
                             Kabupaten Bondowoso.</p>
                         <p>Perusahaan Daerah Air Minum (PDAM) Kabupaten Bondowoso didirikan berdasarkan Peraturan Daerah Nomor 2
                             Tahun 1993 tanggal 23 April 1993 yang
                             telah disempurnakan dengan Peraturan Daerah Nomor 6 Tahun 2011 tanggal 1 Agustus 2011. Dimana
                             pembentukannya merupakan pengalihan status dari Badan Pengelola Air Minum (BPAM) sesuai Surat Keputusan
                         ...
                         <p>
                             Perusahaan Daerah Air Minum (PDAM) Kabupaten Bondowoso yang merupakan satu-satunya BUMD di Kabupaten
                             Bondowoso memiliki fungsi yang strategis dalam pengelolaan potensi sumber daya alam
                             daerah yakni air. Sumber daya air termasuk pelimpahan nikmat yang diberikan
                             Tuhan Yang Maha Esa pada manusia yang ada di bumi ini yang dapat dimanfaatkan
                             dalam berbagai bentuk keperluan manusia. Pemanfaatan air menjadi komponen
                             penting bagi kehidupan seperti dalam proses kebutuhan rumah tangga, perusahaan,
                             instansi publik, pertanian, peternakan, yang dapat dimanfaatkan baik dalam segi
                             komersial maupun non komersial.
                         </p>
                     </div>
                 </div>
                 <div class="col-lg-5 img-bg" style="background-image: url(assets/img/hero-carousel/hero12.jpg); background-repeat: no-repeat;" data-aos="zoom-in" data-aos-delay="100"></div>
     ...
     <section id="visimisi" class="visiMisi">
         <div class="container" data-aos="fade-up">
             ...
             <div class="row justify-content-around gy-4">
                 <div class="col-lg-6 img-bg" style="background-image: url(assets/img/hero-carousel/hero5.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>

                 <div class="col-lg-5 d-flex flex-column justify-content-center">
                     <h3>Visi dan Misi PDAM Bondowoso</h3>
                     <p>Menjadikan Perusahaan Air Minum Yang Sehat, Mandiri dan Terbaik
                         Dalam Pelayanan</p>
                     <p>Untuk mewujudkan misi tersebut diperlukan Visi yaitu :</p>

                     <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
                         <i class="bi bi-patch-check flex-shrink-0"></i>
                         <div>
                             <h4><a href="" class="stretched-link">Meningkatkan kualitas, kuantitas dan kontinyuitas pelayanan demi
                                     kepuasan pelanggan</a></h4>
                         </div>
                     </div><!-- End Icon Box -->
                     ...
                     <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="200">
                         <i class="bi bi-patch-check flex-shrink-0"></i>
                         <div>
                             <h4><a href="" class="stretched-link">Memperluas wilayah cakupan pelayanan</a></h4>
                         </div>
                     </div><!-- End Icon Box -->
                     ...
                     <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                         <i class="bi bi-patch-check flex-shrink-0"></i>
                         <div>
                             <h4><a href="" class="stretched-link">Menjadikan perusahaan sehat dan pelayanan prima</a></h4>
                         </div>
                     </div><!-- End Icon Box -->
                     ...
                     <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
                         <i class="bi bi-patch-check flex-shrink-0"></i>
                         <div>
                             <h4><a href="" class="stretched-link">Meningkatkan profesionalisme dan kesejahteraan pegawai</a></h4>
                         </div>
                     </div><!-- End Icon Box -->
                     ...
                     <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="500">
                         <i class="bi bi-patch-check flex-shrink-0"></i>
                         <div>
                             <h4><a href="" class="stretched-link">Memberikan kontribusi PAD</a></h4>
                         </div>
                     </div><!-- End Icon Box -->
                         ...
                         <div class="col-lg-8 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
                             <ul>
                                 ...
                                 <li><i class="bi bi-check2-all"></i> Dimana pembentukannya merupakan pengalihan status dari Badan
                                     ...
                                     Menteri Pekerjaan Umum Nomor 21/KPTS/1088 tanggal 11 Januari 1989 dan beroperasi secara komersial
                                     tanggal 1 April 1989. Pengalihan status BPAM menjadi PDAM berdasarkan Berita Acara Nomor :
                                     6090/2769/023/1992 dan 690/3567/438.23/1992 tanggal 28 Desember 1992.</li>
                             </ul>
                         </div>
                     ...
                     <div class="row">
                         <div class="col-lg-8 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                             <ul>
                                 ...
                                 <li><i class="bi bi-check2-all"></i> Peraturan Menteri Dalam Negeri Nomor 2 Tahun 2007 tentang Organ
                                     dan Kepegawaian Perusahaan Daerah Air Minum.</li>
                                 <li><i class="bi bi-check2-all"></i> Peraturan Daerah Kabupaten Daerah Tingkat II Bondowoso Nomor : 2
                                     Tahun 1993 Tanggal 23 April 1993 tentang Pendirian Perusahaan
                                     Daerah Air Minum Kabupaten Dati II Bondowoso.
                                 </li>
                                 <li><i class="bi bi-check2-all"></i> Peraturan Daerah Kabupaten Bondowoso Nomor : 6 Tahun 2011
                                     tentang Perubahan Peraturan Daerah Kabupaten Daerah Tingkat II
                                     Bondowoso Nomor : 2 Tahun 1993 tentang Pendirian Perusahaan
                                     Daerah Air Minum Kabupaten Dati II Bondowoso.
                                 </li>
                             </ul>
                         </div>
                     ...
                     <div class="row">
                         <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                             <ul>
                                 ...
                                 <li><i class="bi bi-check2-all"></i> Peraturan Daerah Kabupaten Daerah Tingkat II Bondowoso Nomor :
                                     2 Tahun 1993 Tanggal 23 April 1993 tentang Pendirian Perusahaan
                                     Daerah Air Minum Kabupaten Dati II Bondowoso
                                 </li>
                             </ul>
                         </div>
             ...
             <div class="row gy-4">
                 ...
                 <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
                     <div class="card-item">
                         <div class="row">
                             <div class="col-xl-12">
                                 <div class="card-bg" style="background-image: url(assets/img/Struktur.jpg);"></div>
                             </div>
                         </div>
                     </div>
                 </div><!-- End Card Item -->
