        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('lembar_kerja/pendapatan_non_air') ?>"><button class="float-end neumorphic-button"><i class="fas fa-arrow-left"></i> Kembali</button></a>
                </div>
                <div class="p-2">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <form action="<?= site_url('lembar_kerja/pendapatan_non_air/proses_generate') ?>" method="post" class="form-inline">
                                ...
                                <div class="form-group mr-3">
                                    <label class="mr-2">Tahun Pembuatan RKAP:</label>
                                    ...
                                    <small class="form-text text-muted" style="font-style: italic; font-size: 12px;">Tahun Tidak perlu diganti</small>
                                </div>
                                <div class="form-group mr-3">
