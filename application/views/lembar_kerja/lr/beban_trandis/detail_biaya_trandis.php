                ...
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="navbar-nav">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('lembar_kerja/lr/beban_trandis/export_pdf_detail/' . $kode_akun) ?>" style="font-size: 0.8rem; color:black;">
                                <button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button>
                            </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/lr/beban_trandis?tahun_rkap=' . $tahun) ?>" style="font-size: 0.8rem; color:black;">
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                                                            ...
                                                            if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                                                <a href="<?= base_url('lembar_kerja/lr/beban_trandis/edit/' . urlencode(base64_encode($row['unique_key']))) ?>" title="Edit">
