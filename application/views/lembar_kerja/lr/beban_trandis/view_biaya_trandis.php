            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('lembar_kerja/lr/beban_trandis') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/lr/beban_trandis') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('lembar_kerja/lr/beban_trandis/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button> </a>
                        </div>
                        <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                            ...
                            if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                ...
                                <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/lr/beban_trandis/generate') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Generate ke Cetet</button> </a>
                            </div> -->
                                ...
                                <div class="navbar-nav">
                                    <button id="btnGenerateHpp" class="neumorphic-button" style="font-size: 0.8rem; color:black;">
                                        Generate HPP
                                    </button>
                                </div>
                                <div class="navbar-nav">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" style="font-size: 0.7rem;" id="example3">
                                        ...
                                        <?php foreach ($biaya as $parent) : ?>
                                            ...
                                            ?>
                                                ...
                                                <tr class="fw-bold">
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($upk == 'all' || $upk == '') : ?>
                                                            <a href="<?= base_url('lembar_kerja/lr/beban_trandis/detail/' . urlencode($parent['kode']) . '?tahun_rkap=' . $tahun) ?>" title="Lihat Detail">
                                    ...
                                    <tfoot class="fw-bold" style="background-color: #e9ecef; border-top: 2px solid #6c757d;">
                                        <tr>
                                            <td colspan="2">JUMLAH BIAYA TRANSMISI & DISTRIBUSI</td>
                                ...
                                ?>
                                    <h5 class="text-center"><?= $title2 . ' ' .  $tahun; ?></h5>
    ...
    <script>
        document.getElementById('btnGenerate').addEventListener('click', function(e) {
            ...
            <p style="font-size:18px; margin-top:10px;">
                Pastikan semua data <b>Biaya Transmisi & Distribusi</b> sudah <b>final</b> sebelum melakukan generate.
                <br><br>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('lembar_kerja/lr/beban_trandis/generate') ?>";
                }
            });
        });
    </script>
    <script>
        document.getElementById('btnGenerateHpp').addEventListener('click', function(e) {
            e.preventDefault();

            Swal.fire({
                title: 'Yakin ingin Generate Data HPP?',
                html: `
            <p style="font-size:18px; margin-top:10px;">
        ...
        `,
                ...
                if (result.isConfirmed) {
                    // Redirect ke controller generate
                    window.location.href = "<?= base_url('lembar_kerja/lr/beban_trandis/generate_hpp') ?>";
                }
            });
        });
    </script>