            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('lembar_kerja/lr/beban_umum') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/lr/beban_umum') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('lembar_kerja/lr/beban_umum/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button> </a>
                        </div>
                        <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                            ...
                            if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                ...
                                <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/lr/beban_umum/generate') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Generate ke Cetet</button> </a>
                            </div> -->
                                <div class="navbar-nav">
                                ...
                                <div class="navbar-nav">
                                    <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/lr/beban_umum/tambah') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Input Biaya</button> </a>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </nav>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($biaya as $parent) : ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                                                                    ...
                                                                    $level = $this->session->userdata('level');
                                                                    if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                                                        <a href="<?= base_url('lembar_kerja/lr/beban_umum/edit/' . urlencode(base64_encode($c['unique_key']))) ?>"><i class="fas fa-edit"></i></a>
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr class="fw-bold">
                                                ...
                                                <td class="text-center">
                                                    <?php if ($upk == 'all' || $upk == '') : ?>
                                                        <a href="<?= base_url('lembar_kerja/lr/beban_umum/detail/' . urlencode($parent['kode']) . '?tahun_rkap=' . $tahun) ?>" title="Lihat Detail">
    ...
    <script>
        document.getElementById('btnGenerate').addEventListener('click', function(e) {
            ...
            <p style="font-size:18px; margin-top:10px;">
                Pastikan semua data <b>Biaya Umum & Administrasi</b> sudah <b>final</b> sebelum melakukan generate.
                <br><br>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('lembar_kerja/lr/beban_umum/generate') ?>";
                }
            });
        });
    </script>