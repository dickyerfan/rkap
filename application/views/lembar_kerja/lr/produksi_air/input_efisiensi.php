                        ...
                        <div class="col-md-6">
                            <form method="post" action="" class="mb-3">
                                <div class="form-group mb-3">
                                    <label>Tahun</label>
                                    <input type="number" name="tahun" value="<?= date('Y') + 1 ?>" class="form-control" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label>Efisiensi (%)</label>
                                    <input type="number" step="0.01" name="efisiensi" class="form-control" placeholder="contoh: 75.00" required>
                                </div>
                                <div class="form-group mb-3">
