                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" style="font-size: 0.7rem;" id="example3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                                                                    ...
                                                                    $level = $this->session->userdata('level');
                                                                    if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                                                        <a href="<?= base_url('lembar_kerja/lr/beban_sumber/edit/' . urlencode(base64_encode($c['unique_key']))) ?>"><i class="fas fa-edit"></i></a>
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                    ...
                                    <tfoot class="fw-bold" style="background-color: #e9ecef; border-top: 2px solid #6c757d;">
                                        <tr>
                                            <td colspan="2">JUMLAH BIAYA SUMBER</td>
    ...
    <script>
        document.getElementById('btnGenerate').addEventListener('click', function(e) {
            ...
            <p style="font-size:18px; margin-top:10px;">
                Pastikan semua data <b>Biaya Sumber</b> sudah <b>final</b> sebelum melakukan generate.
                <br><br>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('lembar_kerja/lr/beban_sumber/generate') ?>";
                }
            });
        });
    </script>