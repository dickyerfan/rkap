            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('lembar_kerja/rkap_amdk/produksi/tarif') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            ...
                            <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/rkap_amdk/produksi/tarif') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                                        ...
                                        foreach ($data as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <!-- <a href="<?= base_url('lembar_kerja/rkap_amdk/produksi/edit_tarif/' . $row->id_tarif) ?>" class="btn btn-sm btn-warning">
                                                        Edit
                                                    </a> -->
