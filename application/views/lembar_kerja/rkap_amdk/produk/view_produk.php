            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('lembar_kerja/rkap_amdk/produksi/produk') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/rkap_amdk/produksi/produk') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                            ...
                            if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                <div class="navbar-nav ms-auto">
                                    <!-- <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/rkap_amdk/produksi/tambah_produk') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Input Data</button> </a> -->
                                    <a href="<?= base_url('lembar_kerja/rkap_amdk/produksi/copy_produk?tahun_rkap=' . ($tahun)) ?>">
                                        ...
                                        foreach ($data as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <!-- <a href="<?= base_url('lembar_kerja/rkap_amdk/produksi/edit_produk/' . $row->id_produk) ?>" class="btn btn-sm btn-warning">
                                                        Edit
                                                    </a> -->
