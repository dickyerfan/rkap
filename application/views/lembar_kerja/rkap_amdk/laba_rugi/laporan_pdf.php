                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    for ($m = 1; $m <= 12; $m++) :
                                        ...
                                        $total += $v;
                                    ?>
                                        <td class="text-end pe-1"><?= number_format($v, 0, ',', '.') ?></td>
                                    <?php endfor; ?>
                                    <td class="text-end pe-1 fw-bold"><?= number_format($total, 0, ',', '.') ?></td>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    for ($m = 1; $m <= 12; $m++) {
                                        ...
                                        echo '<td class="text-end pe-1 fw-bold">' . number_format($subPendapatan, 0, ',', '.') . '</td>';
                                    }
                                    ?>
                                    <td class="text-end pe-1 fw-bold"><?= number_format($grand_total, 0, ',', '.') ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    for ($m = 1; $m <= 12; $m++) {
                                        ...
                                        echo '<td class="text-end pe-1 fw-bold">' . number_format($subBeban, 0, ',', '.') . '</td>';
                                    }
                                    ?>
                                    <td class="text-end pe-1 fw-bold"><?= number_format($grand_total, 0, ',', '.') ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    for ($m = 1; $m <= 12; $m++) {
                                        ...
                                        echo '<td class="text-end pe-1 fw-bold">' . number_format($labaRugiKotor, 0, ',', '.') . '</td>';
                                    }
                                    ?>
                                    <td class="text-end pe-1 fw-bold"><?= number_format($grand_total, 0, ',', '.') ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    for ($m = 1; $m <= 12; $m++) {
                                        ...
                                        echo '<td class="text-end pe-1 fw-bold">' . number_format($hasil, 0, ',', '.') . '</td>';
                                    }
                                    ?>
                                    <td class="text-end pe-1 fw-bold"><?= number_format($grand_total, 0, ',', '.') ?></td>
                                </tr>
