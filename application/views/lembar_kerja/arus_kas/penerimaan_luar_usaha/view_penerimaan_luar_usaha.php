            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('lembar_kerja/arus_kas/penerimaan_luar_usaha') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/arus_kas/penerimaan_luar_usaha') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('lembar_kerja/arus_kas/penerimaan_luar_usaha/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button> </a>
                        </div>
    ...
    <script>
        document.getElementById('btnGenerate').addEventListener('click', function(e) {
            ...
            <p style="font-size:18px; margin-top:10px;">
                Pastikan semua data <b>Penerimaan Lain-lain</b> sudah <b>final</b> sebelum melakukan generate.
                <br><br>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('lembar_kerja/arus_kas/penerimaan_luar_usaha/generate') ?>";
                }
            });
        });
    </script>