            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('lembar_kerja/arus_kas/investasi') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/arus_kas/investasi') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('lembar_kerja/arus_kas/investasi/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button> </a>
                        </div>
                        <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                            ...
                            if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                <div class="navbar-nav">
                                    <!-- <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/arus_kas/investasi/generate') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Generate ke Arus Kas</button> </a> -->
                                    <button id="btnGenerate" class="neumorphic-button" style="font-size: 0.8rem; color:black;">
                                        Generate ke Arus Kas
                                    </button>
                                </div>
                                <div class="navbar-nav">
                                    <a class="nav-link fw-bold" href="<?= base_url('lembar_kerja/arus_kas/investasi/tambah') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Input Investasi</button> </a>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </nav>
                                            ...
                                            <?php if (!empty($parent['children'])) : ?>
                                                <?php foreach ($parent['children'] as $c) : ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($this->session->userdata('tipe') == 'admin') : ?>
                                                            <td>
                                                                <!-- <a href="<?= base_url('lembar_kerja/arus_kas/investasi/edit/' . $c['cabang_id'] . '/' . $c['kode'] . '/' . urlencode($c['uraian'])) ?>">
                                                                ...
                                                                $level = $this->session->userdata('level');
                                                                if (can_input($nama_pengguna, $level, $status_periode, $tahun)) : ?>
                                                                    <a href="<?= base_url('lembar_kerja/arus_kas/investasi/edit/' . $c['cabang_id'] . '/' . $c['kode'] . '/' . base64_encode($c['uraian'])) ?>">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                <?php endif; ?>
                                                            </td>
    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('lembar_kerja/arus_kas/investasi/generate') ?>";
                }
            });
        });
    </script>