                        ...
                        <div class="col-md-10">
                            ...
                            <!-- <script>
                                ...
                                function formatRupiah(input) {
                                    // 1. Ambil nilai, hapus selain angka
                                    let value = input.value.replace(/[^,\d]/g, '').toString();

                                    // 2. Buat format ribuan
                                ...
                                // PENTING: Saat submit, form mengirimkan nilai '1.000.000'. 
                                // Di controller, saya sudah tambahkan 'preg_replace' untuk membersihkannya
                                // menjadi '1000000' sebelum disimpan.
                            </script> -->
                        </div>
                    </div>
                </div>
