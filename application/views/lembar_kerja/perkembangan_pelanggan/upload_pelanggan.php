        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('lembar_kerja/pelanggan') ?>"><button class="float-end neumorphic-button"><i class="fas fa-arrow-left"></i> Kembali</button></a>
                </div>
                <div class="p-2">
                ...
                <div class="card-body">
                    <form action="<?= site_url('lembar_kerja/pelanggan/insert_data') ?>" method="post">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    <label>Tahun</label>
                                    <input type="number" name="tahun" value="<?= date('Y') ?>" class="form-select" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label>Bulan</label>
