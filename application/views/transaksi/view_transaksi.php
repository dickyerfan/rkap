            ...
            <div class="card">
                <div class="card-header shadow">
                    <div class="row title">
                        ...
                        <div class="col-lg-5">
                            <a href="<?= base_url('transaksi/tambah'); ?>"><button class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Input Transaksi</button></a>
                            <button id="belum" class="btn btn-warning btn-sm"><i class="fas fa-calendar-alt"></i> Pilih Waktu</button>
                            <!-- <button id="ambilSaldo" class="btn btn-success btn-sm"><i class="fas fa-dollar"></i> Saldo Awal</button> -->
                            <a href="<?= base_url('transaksi/ambilSaldoAwal'); ?>"><button class="btn btn-success btn-sm"><i class="fas fa-dollar"></i> Saldo Awal</button></a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center mb-1" id="tampilTanggal" style="display: none;">
                        <div class="col-md-4">
                            <div class="card bg-light shadow text-center text-dark">
                                <div class="card-body">
                                    <!-- <h3>Pilih Bulan & Tahun</h3> -->
                                    <form action="<?= base_url() ?>transaksi/ambilSaldo" method="POST">
                                        <div class="form-group">
                                            ...
                                            <!-- <select name="tahun" class="form-select mb-1">
                                            <option value="<?php echo $tahun = date('Y'); ?>">Tahun</option>
                                                <?php
                                                $mulai = date('Y') - 2;
                                                for ($i = $mulai; $i < $mulai + 11; $i++) {
                                                    $sel = $i == date('Y') ? ' selected="selected"' : '';
                                        ...
                                        <div class="d-grid gap-2">
                                            <button type="submit" name="tanggalPilih" id="tanggalPilih" class="btn btn-block btn-primary">Input Saldo Awal </button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= ($row->kode_saldo == 1) ? 'javascript:void(0)' : base_url(); ?>transaksi/edit/<?= $row->id; ?>"><span class="btn btn-primary btn-sm"><i class=" fas fa-fw fa-edit"></i></span></a>
                                            <a href="<?= ($row->kode_saldo == 1) ? 'javascript:void(0)' : site_url('transaksi/hapus/' . $row->id); ?>" class="btn btn-danger btn-sm"><i class="fas fa-fw fa-trash"></i></a>
