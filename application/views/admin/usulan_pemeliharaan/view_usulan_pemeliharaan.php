            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('admin/usulan_pemeliharaan') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('admin/usulan_pemeliharaan') ?>" style="font-size: 0.8rem; color:black;"><button class=" neumorphic-button"> Reset</button></a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" href="<?= site_url('admin/usulan_pemeliharaan/export_pdf'); ?>" target="_blank" style="font-size: 0.8rem; color:black;"><button class=" neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button></a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="<?= ($row->status_upload == 1) ? 'table-danger' : ''; ?>">
                                                ...
                                                <a href="<?= base_url('admin/usulan_pemeliharaan/detail_usulan_pemeliharaan/') . $id ?>" style="margin:0 1px; text-decoration:none; display:inline-block;" data-bs-toggle="tooltip" data-bs-placement="top" title="Klik Untuk Melihat Detail Data">
                                                ...
                                                <?php if ($username === 'administrator') : ?>
                                                        ...
                                                        <a href="<?= base_url('admin/usulan_pemeliharaan/edit_usulan_pemeliharaan/') . $id ?>" style="margin:0 1px; text-decoration:none; display:inline-block;" data-bs-toggle="tooltip" data-bs-placement="top" title="Klik Untuk Edit Data">
                                                            <i class="fas fa-edit text-success" style="vertical-align:middle;"></i>
                                                        </a>
                                                        <a href="<?= base_url('admin/usulan_pemeliharaan/hapus_usulan_pemeliharaan/') . $id ?>" class="hapus-link" style="margin:0 1px; text-decoration:none; display:inline-block;" data-bs-toggle="tooltip" data-bs-placement="top" title="Klik Untuk Hapus Data">
                                                            <i class="fas fa-trash text-danger" style="vertical-align:middle;"></i>
                                                        </a>
                                                        <a href="<?= base_url('admin/usulan_pemeliharaan/generate_usulan_pemeliharaan/') . $id ?>" style="margin:0 1px; text-decoration:none; display:inline-block;" data-bs-toggle="tooltip" data-bs-placement="top" title="Klik Untuk Generate Data ke Biaya (Laba Rugi)">
                                                ...
                                                <?php if ($username === 'administrator' && $tahun == $tahun_sekarang && !$is_locked) : ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('admin/usulan_pemeliharaan/export_pdf') ?>" method="post" target="_blank">
