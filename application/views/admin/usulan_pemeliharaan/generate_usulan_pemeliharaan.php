        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('admin/usulan_pemeliharaan') ?>">
                ...
                <div class="card-body">
                    <form method="post">
                        <input type="hidden" name="id_usulanPemeliharaan" value="<?= $usulan_pemeliharaan->id_usulanPemeliharaan ?>">
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="form-group mb-2">
                                    <label>Tahun Pembuatan RKAP</label>
                                    <input type="text" class="form-control" readonly value="<?= $usulan_pemeliharaan->tahun_rkap ?>">
                                </div>
                                <div class="form-group mb-2">
                                    <label>No Perkiraan</label>
                                    <input type="text" class="form-control" readonly value="<?= $usulan_pemeliharaan->no_perkiraan ?>">
                                </div>
                                <div class="form-group mb-2">
                                    <label>Nama Perkiraan</label>
                                    <input type="text" class="form-control" readonly value="<?= $usulan_pemeliharaan->nama_perkiraan ?>">
                                </div>
                                <div class="form-group mb-4">
                                    <label>Biaya</label>
                                    <input type="text" class="form-control" readonly value="<?= number_format($usulan_pemeliharaan->biaya, 0, ',', '.') ?>">
                                </div>
                                <div class="alert alert-info">
                                    <table class="table table-borderless table-sm mb-0">
                                        <tr>
                                            <td width="180">Bagian / UPK</td>
                                            <td>: <?= $usulan_pemeliharaan->bagian_upk ?></td>
                                        </tr>
                                        <tr>
                                            <td>Tahun RKAP</td>
                                            <td>: <?= $usulan_pemeliharaan->tahun_rkap + 1 ?></td>
                                        </tr>
                                        <tr>
                                            <td>Status</td>
