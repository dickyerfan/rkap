        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('admin/usulan_umum') ?>">
                ...
                <div class="card-body">
                    <form method="post">
                        <input type="hidden" name="id_usulanUmum" value="<?= $usulan_umum->id_usulanUmum ?>">
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="form-group mb-2">
                                    <label>Tahun Pembuatan RKAP</label>
                                    <input type="text" class="form-control" readonly value="<?= $usulan_umum->tahun_rkap ?>">
                                </div>
                                <div class="form-group mb-2">
                                    <label>No Perkiraan</label>
                                    <input type="text" class="form-control" readonly value="<?= $usulan_umum->no_perkiraan ?>">
                                </div>
                                <div class="form-group mb-2">
                                    <label>Nama Perkiraan</label>
                                    <input type="text" class="form-control" readonly value="<?= $usulan_umum->nama_perkiraan ?>">
                                </div>
                                ...
                                <div class="alert alert-info">
                                    <table class="table table-borderless table-sm mb-0">
                                        <tr>
                                            ...
                                            <td>: <?= $usulan_umum->bagian_upk ?></td>
                                        </tr>
                                        <tr>
                                            <td>Tahun RKAP</td>
                                            <td>: <?= $usulan_umum->tahun_rkap + 1 ?></td>
                                        </tr>
                                        <tr>
                                            <td>Status</td>
