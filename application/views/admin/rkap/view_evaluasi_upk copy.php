<div id="layoutSidenav_content" class="latar">
    <main>
        <div class="container-fluid px-2 mt-2">
            <div class="card mb-1">
                <div class="card-header shadow" style="display: flex; align-items: center; justify-content: start;">
                    <a class="text-dark pe-2" style="text-decoration:none;">Pilih UPK</a>
                    <form action="<?= base_url('admin/evaluasi_upk') ?>" method="post">
                        <div style="display: flex; align-items: center;">
                            <select name="bagian_upk" class="form-select" aria-label="Default select example">
