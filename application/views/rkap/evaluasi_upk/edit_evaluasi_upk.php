    ...
    <main>
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="user" action="<?= base_url('rkap/evaluasi_upk/update_evaluasi_upk') ?>" method="POST">
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <input type="hidden" name="id_evaluasi_upk" id="id_evaluasi_upk" value="<?= $evaluasi_upk->id_evaluasi_upk; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="1" class="form-control" id="rkap" name="rkap" value="<?= $evaluasi_upk->rkap; ?>">
                                    <small class="form-text text-danger pl-3"><?= form_error('rkap'); ?></small>
                                </div>
                                <div class="form-group">
                                    <label for="realisasi">Realisasi :</label>
                                    <input type="number" step="1" class="form-control" id="realisasi" name="realisasi" value="<?= $evaluasi_upk->realisasi; ?>">
