        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    <a class="fw-bold text-dark" style="text-decoration:none ;"><?= strtoupper($title) . ' ' . date('Y') + 1 ?></a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="usulan_teknik" id="" cols="30" rows="10"><?= set_value('usulan_teknik'); ?></textarea>
