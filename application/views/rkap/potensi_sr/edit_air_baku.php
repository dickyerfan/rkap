    ...
    <main>
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="user" action="<?= base_url('rkap/potensi_sr/update_air_baku') ?>" method="POST">
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                <input type="hidden" name="id_tambah_air_baku" id="id_tambah_air_baku" value="<?= $airBaku->id_tambah_air_baku; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="uraian" id="" cols="30" rows="10"><?= $airBaku->uraian; ?></textarea>
