                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_wil" name="nama_wil" value="<?= set_value('nama_wil'); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_sr" name="jumlah_sr" value="<?= set_value('jumlah_sr'); ?>">
