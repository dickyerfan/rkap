                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('rkap/isian_barang/edit_isian_barang/') ?><?= $id ?>"><span class="text-dark neumorphic-button" style="text-decoration: none;"><i class="fas fa-edit text-success"></i> Isi Harga</span></a>
