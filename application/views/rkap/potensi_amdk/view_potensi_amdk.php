                ...
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <div class="navbar-nav">
                            <a class="nav-link fw-bold neumorphic-button" target="_blank" href="<?= base_url('rkap/potensi_amdk/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><i class="fa-solid fa-file-pdf"></i> Export PDF</a>
                        </div>
                        <div class="nav-item dropdown ms-auto">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?= base_url('rkap/potensi_amdk/upload') ?>" style="font-size: 0.8rem;"><i class="fa-solid fa-upload "></i> Input Pendapatan</a></li>
                                <li><a class="dropdown-item" href="<?= base_url('rkap/potensi_amdk/upload_biaya') ?>" style="font-size: 0.8rem;"><i class="fa-solid fa-upload "></i> Input Biaya</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
