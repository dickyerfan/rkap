        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card mb-1">
                <div class="card-header shadow">
                    ...
                    <h6 class="nav-item dropdown float-end">
                        <a class="nav-link dropdown-toggle fw-bold neumorphic-button" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 0.8rem; color:black;">Upload Data</a>
                ...
                <div class="card-body">
                    ...
                    <?php foreach ($keterangan as $row) : ?>
                        <div class="row justify-content-center">
                            <div class="col-lg-3"><?= $row->nama_wil ?></div>
                            <div class="col-lg-1">:</div>
                            <div class="col-lg-1"><?= $row->jumlah_sr ?></div>
                            <div class="col-lg-2">SR</div>
                        </div>
                    <?php endforeach; ?>
                    <div class="row justify-content-center p-3">
                        <div class="col-lg-9">
                            ...
                            <?php foreach ($airBaku as $row) : ?>
                                <div class="row justify-content-center">
                                    <div class="col-lg-12">
                                        <span class="ps-4"><?= $row->uraian ?></span>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
