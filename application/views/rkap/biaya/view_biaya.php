            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('rkap/biaya') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('rkap/biaya') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('rkap/biaya/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button> </a>
                        </div>
                        <!-- <div class="navbar-nav">
                            <a class="nav-link fw-bold" href="<?= base_url('rkap/biaya/tambah') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Input Biaya</button> </a>
                        </div> -->
                    </nav>
                </div>
                <div class="p-2">
    ...
    <!-- <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('rkap/biaya/generate') ?>";
                }
            });
        });
    </script> -->