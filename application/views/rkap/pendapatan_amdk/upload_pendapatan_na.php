        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('rkap/pendapatan_na_amdk') ?>"><button class="float-end neumorphic-button"><i class="fas fa-arrow-left"></i> Kembali</button></a>
                </div>
                <div class="p-2">
                ...
                <div class="card-body">
                    <form action="<?= site_url('rkap/pendapatan_na_amdk/save') ?>" method="post">
                        <div class="row">
                            <div class="col-md-6">
