        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('rkap/usulan_inves') ?>"><button class="float-end neumorphic-button"><i class="fas fa-arrow-left"></i> Kembali</button></a>
                </div>
                <div class="p-2">
                ...
                <div class="card-body">
                    <form class="user" action="<?= base_url('rkap/usulan_inves/update') ?>" method="POST" enctype="multipart/form-data">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <input type="text" class="form-control" id="satuan" name="satuan" value="<?= $usulan_investasi->satuan; ?>"> -->
                                    <select name="satuan" id="satuan" class="form-select">
                                        ...
                                        <option value="Set" <?= $usulan_investasi->satuan == "Set" ? 'selected' : '' ?>>Set</option>
                                    </select>
