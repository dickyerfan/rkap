                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <input type="text" class="form-control" id="latar_belakang" name="latar_belakang" value="<?= set_value('latar_belakang'); ?>"> -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <input type="text" class="form-control" id="solusi" name="solusi" value="<?= set_value('solusi'); ?>"> -->
