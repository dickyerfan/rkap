            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('rkap/investasi_amdk') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('rkap/investasi_amdk') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('rkap/investasi_amdk/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button> </a>
                        </div>
                        <div class="navbar-nav">
                            <a class="nav-link fw-bold" href="<?= base_url('rkap/investasi_amdk/tambah') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Input Investasi</button> </a>
                        </div>
                    </nav>
                </div>
                <div class="p-2">
                                                ...
                                                <?php foreach ($parent['children'] as $c) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?= base_url('rkap/investasi_amdk/edit/' . $c['cabang_id'] . '/' . $c['kode'] . '/' . base64_encode($c['uraian'])) ?>">
    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('rkap/investasi_amdk/generate') ?>";
                }
            });
        });
    </script>