    ...
    <main>
        <div class="container-fluid px-2 mt-2">
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-light bg-light">
                        ...
                        <div class="navbar-nav ms-auto">
                            <a href="<?= base_url('rkap/proyeksi_upk') ?>"><button class="float-end neumorphic-button"><i class="fa-solid fa-arrow-left"></i> Kembali</button></a>
                        </div>
                    </nav>
                </div>
                ...
                ?>
                <div class="card-body">
                    <form action="<?= base_url('rkap/proyeksi_upk/upload') ?>" method="post">
                        ...
                        <a href="<?= base_url('rkap/proyeksi_upk') ?>"><button type="button" class="neumorphic-button">Batal</button></a>
                    </form>
                </div>
            </div>
        </div>
