        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card mb-1">
                <div class="card-header shadow">
                    <a class="fw-bold text-dark text-uppercase" style="text-decoration:none ;">Isian Investasi </a>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('rkap/isian_inves/edit_isian_inves/') ?><?= $id ?>"><span class="text-dark neumorphic-button" style="text-decoration: none;"><i class="fas fa-edit text-success"></i> Isi Harga</span></a>
