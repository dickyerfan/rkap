<div id="layoutSidenav_content" class="latar">
        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header shadow">
                    ...
                    <a href="<?= base_url('rkap/bahan_baku') ?>"><button class="float-end neumorphic-button"><i class="fas fa-arrow-left"></i> Kembali</button></a>
                </div>
                <div class="p-2">
                    ...
                    <form method="post" action="" class="mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="id_produk" id="id_produk" class="form-select" required>
                                ...
                                <option value="7">Perlengkapan Lab</option>
                                <option value="8">Perlengkapan Lainnya</option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
    ...
    <script>
        ...
        const produkSelect = document.getElementById('id_produksi');
