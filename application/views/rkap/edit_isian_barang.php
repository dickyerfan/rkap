                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="1" class="form-control" id="volume" name="volume" value="<?= $isian_barang->volume; ?>" disabled>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="satuan" id="satuan" class="form-select" disabled>
                                        <option value="Meter" <?= $isian_barang->satuan == "Meter" ? 'selected' : '' ?>>Meter</option>
                                        <option value="Unit" <?= $isian_barang->satuan == "Unit" ? 'selected' : '' ?>>Unit</option>
                                        <option value="Ruangan" <?= $isian_barang->satuan == "Ruangan" ? 'selected' : '' ?>>Ruangan</option>
                                        <option value="Buah" <?= $isian_barang->satuan == "Buah" ? 'selected' : '' ?>>Buah</option>
                                        <option value="Pasang" <?= $isian_barang->satuan == "Pasang" ? 'selected' : '' ?>>Pasang</option>
                                        <option value="Box" <?= $isian_barang->satuan == "Box" ? 'selected' : '' ?>>Box</option>
                                        <option value="Botol" <?= $isian_barang->satuan == "Botol" ? 'selected' : '' ?>>Botol</option>
                                        <option value="Lusin" <?= $isian_barang->satuan == "Lusin" ? 'selected' : '' ?>>Lusin</option>
                                        <option value="Kg" <?= $isian_barang->satuan == "Kg" ? 'selected' : '' ?>>Kg</option>
                                        <option value="M2" <?= $isian_barang->satuan == "M2" ? 'selected' : '' ?>>M2</option>
                                        <option value="Rim" <?= $isian_barang->satuan == "Rim" ? 'selected' : '' ?>>Rim</option>
                                        <option value="Set" <?= $isian_barang->satuan == "Set" ? 'selected' : '' ?>>Set</option>
                                    </select>
