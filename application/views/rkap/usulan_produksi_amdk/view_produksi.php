            ...
            <div class="card mb-1">
                <div class="card-header shadow">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <form action="<?= base_url('rkap/usulan_produksi_amdk') ?>" method="get">
                        ...
                        <div class="navbar-nav ms-2">
                            <a class="nav-link fw-bold" href="<?= base_url('rkap/usulan_produksi_amdk') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Reset</button> </a>
                        </div>
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link fw-bold" target="_blank" href="<?= base_url('rkap/usulan_produksi_amdk/export_pdf') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"><i class="fa-solid fa-file-pdf"></i> Export PDF</button> </a>
                        </div>
                        <div class="navbar-nav">
                            <a class="nav-link fw-bold" href="<?= base_url('rkap/usulan_produksi_amdk/tambah') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Input Data</button> </a>
                        </div>
                        <div class="navbar-nav">
                            <a class="nav-link fw-bold" href="<?= base_url('rkap/usulan_produksi_amdk/persen') ?>" style="font-size: 0.8rem; color:black;"><button class="neumorphic-button"> Persentase</button> </a>
                        </div>
                        <div class="navbar-nav">
                                        ...
                                        ?>
                                            <tr class="fw-bold bg-light">
                                                <td><?= $produk['nama_produk'] ?>
                                                    <a href="<?= base_url('rkap/usulan_produksi_amdk/edit/' . $produk['id_produk'] . '/' . $tahun_rkap) ?>" class=" ms-2">
