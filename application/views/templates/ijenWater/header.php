...
<head>
    ...
    <link href="<?= base_url() ?>assets/css/ijen.css" rel="stylesheet">
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Info Pelanggan</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            ...
                            <li><a href="<?= base_url('pelanggan/biayaPasangBaru') ?>">Biaya Pasang baru</a></li>
                            <li><a href="<?= base_url('pelanggan/denda') ?>">Denda / Pembukaan</a></li>
