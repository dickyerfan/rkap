...
class Pendapatan_non_air extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($upk) {
            ...
            $data['title'] = 'RENCANA PENDAPATAN NON AIR UPK <br> TAHUN ANGGARAN ';
        } else {
        ...
        foreach ($data['data_pendapatan_na'] as $row) {
            $pendapatan[$row->jenis_pendapatan][$row->bulan] = $row->nilai;
        }
        ...
        $this->load->view('lembar_kerja/pendapatan_non_air/view_pendapatan_non_air', $data);
    ...
    public function form_generate()
    {
        ...
        $this->load->view('templates/navbar');
        $this->load->view('templates/sidebar');
        $this->load->view('lembar_kerja/pendapatan_non_air/upload_form_generate', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function proses_generate()
    {
        ...
        // redirect ke laporan
        // redirect("lembar_kerja/pendapatan_non_air/laporan/$id_upk/$tahun/$bulan");
        redirect("lembar_kerja/pendapatan_non_air");
    }
