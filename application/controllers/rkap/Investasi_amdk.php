...
class Investasi_amdk extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('rkap/investasi/view_investasi', $data);
        ...
        if ($statusUpload !== null && $statusUpload->status == 0) {
            ...
            if ($this->input->post()) {
                ...
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    ...
                    redirect('rkap/investasi/tambah');
                    return;
                }
                ...
                redirect('rkap/investasi_amdk?upk=' . $upk_redirect . '&tahun_rkap=' . $tahun_rkap);
            } else {
