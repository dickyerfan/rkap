...
class Permasalahan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['tampil'] = $this->Model_permasalahan->getData();

        $data['title'] = 'PERMASALAHAN YANG PERLU DITINDAK LANJUTI TAHUN ';
        $this->load->view('templates/pengguna/header', $data);
        $this->load->view('templates/pengguna/navbar');
        $this->load->view('templates/pengguna/sidebar');
        $this->load->view('rkap/permasalahan/view_permasalahan', $data);
    ...
    {
        $data['tahun'] = $this->Model_permasalahan->getTahun();
        $data['tampil'] = $this->Model_permasalahan->getData();
        $data['title'] = 'PERMASALAHAN YANG PERLU DITINDAK LANJUTI TAHUN ';
        ...
        $this->pdf->filename = "permasalahan-{$upk_bagian}-{$tahun}.pdf";
        $this->pdf->generate('rkap/permasalahan/laporan_pdf', $data);
    }
}
