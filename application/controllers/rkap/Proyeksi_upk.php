...
class Proyeksi_upk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('rkap/proyeksi_upk/view_proyeksi_upk', $data);
    ...
    public function export_pdf()
    {
        ...
        $this->pdf->generate('rkap/proyeksi_upk/laporan_pdf', $data);
    }
        ...
        if ($statusUpload !== null && $statusUpload->status == 0) {
            ...
            if ($this->input->method() === 'post') {
                ...
                if (!empty($errors)) {
                    ...
                    redirect('rkap/proyeksi_upk/upload?tahun_rkap=' . $tahun);
                }
                ...
                if (!$ada_perubahan) {
                    ...
                    redirect('rkap/proyeksi_upk?tahun_rkap=' . $tahun);
                }
            ...
            $this->load->view('templates/pengguna/navbar');
            $this->load->view('templates/pengguna/sidebar');
            $this->load->view('rkap/proyeksi_upk/upload_proyeksi_upk', $data);
            $this->load->view('templates/pengguna/footer');
        }
    }
}
