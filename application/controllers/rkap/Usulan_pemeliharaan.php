...
class Usulan_pemeliharaan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['tampil'] = $this->Model_usulan_pemeliharaan->getData();

        $data['title'] = 'USULAN PEMELIHARAAN (RKAP) TAHUN ';
        $this->load->view('templates/pengguna/header', $data);
        $this->load->view('templates/pengguna/navbar');
        $this->load->view('templates/pengguna/sidebar');
        $this->load->view('rkap/usulan_pemeliharaan/view_usulan_pemeliharaan', $data);
    ...
    public function edit_usulan_pemeliharaan($id_usulanPemeliharaan)
    {
        ...
        if ($statusUpdate !== null && $statusUpdate->status_update == 0 && $this->session->userdata('level') == 'Pengguna') {
            ...
            $this->load->view('templates/pengguna/navbar');
            $this->load->view('templates/pengguna/sidebar');
            $this->load->view('rkap/usulan_pemeliharaan/edit_usulan_pemeliharaan', $data);
            $this->load->view('templates/pengguna/footer');
        }
    }
    ...
    {
        $data['tahun'] = $this->Model_usulan_pemeliharaan->getTahun();
        $data['tampil'] = $this->Model_usulan_pemeliharaan->getData();
        $data['title'] = 'USULAN PEMELIHARAAN (RKAP) TAHUN ';
