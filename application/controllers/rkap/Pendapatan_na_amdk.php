...
class Pendapatan_na_amdk extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('rkap/pendapatan_amdk/view_pendapatan_na', $data);
    ...
    public function tambah()
    {
        ...
        if ($statusUpload !== null && $statusUpload->status == 0) {
            ...
            redirect('rkap/pendapatan_na_amdk');
        } else {
            ...
            $this->load->view('templates/pengguna/navbar');
            $this->load->view('templates/pengguna/sidebar');
            $this->load->view('rkap/pendapatan_amdk/upload_pendapatan_na', $data);
            $this->load->view('templates/pengguna/footer');
        }
    }
