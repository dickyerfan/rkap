...
class Potensi_amdk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['produksi'] = $this->Model_potensi_amdk->getProduksiAmdk();
        $data['biaya'] = $this->Model_potensi_amdk->getAllBiayaAmdk();
        ...
        $this->load->view('admin/potensi_amdk/view_potensi_amdk', $data);
    ...
    //             $this->load->view('admin/potensi_amdk/upload_potensi_amdk', $data);
    ...
    //             $cek = $this->Model_potensi_amdk->cekDuplikat($uraian, $tahun_rkap);
    ...
    //         $this->load->view('templates/pengguna/navbar');
    //         $this->load->view('templates/pengguna/sidebar');
    //         $this->load->view('admin/potensi_amdk/edit_potensi_amdk', $data);
    //         $this->load->view('templates/pengguna/footer');
    //     }
    // }
